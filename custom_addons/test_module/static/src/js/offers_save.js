...
publicWidget.registry.TestModuleOffers2 = publicWidget.Widget.extend({
                ...
                data.forEach(offer=>{
                    ...
                    html += `<div class="col-12">
                                <div class="cont-padding">
                                    <p id="id" style="display:none">${offer.id ? offer.id: ""}</p>
...
export default publicWidget.registry.TestModuleOffers2;
