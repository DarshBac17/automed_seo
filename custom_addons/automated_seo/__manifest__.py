{
    ...
    'data': [
        ...
        "views/snippets/banner/s_full_banner_side_matrix.xml",
        "views/snippets/banner/s_full_banner_side_matrix_icon.xml",
        ...
        "views/snippets/banner/s_full_banner_side_image.xml",
    ...
    'assets': {
        ...
        'web.assets_backend': [
            ...
            'automated_seo/static/src/xml/view_kanban_button.xml',
            'automated_seo/static/src/js/views_kanban_extend.js',
            ...
            'automated_seo/static/src/js/card_selection_widget.js',
            'automated_seo/static/src/js/standard_field_props.js',
            'automated_seo/static/src/css/card_selection_widget.css',
            'automated_seo/static/src/xml/card_selection_widget.xml',
        ],
